...
//     let images = [
//         {
//             imageSrc: "../../../nba_images/nba-landing.png",
//             description: "Landing Page"
//         },
//         {
//             imageSrc: "../../../nba_images/nba-search.png",
//             description: "Search Blog Posts"
//         },
//         {
//             imageSrc: "../../../nba_images/nba-create-new.png",
//             description: "Create New Blog Post"
//         },
//         {
//             imageSrc: "../../../nba_images/nba-blog-post.png",
//             description: "Blog Post Details"
//         },
//         {
//             imageSrc: "../../../nba_images/nba-edit-post.png",
//             description: "Edit Blog Post"
//         },
//         {
//             imageSrc: "../../../nba_images/nba-comment-post.png",
...
<div class="{screen} lg:h-screen px-4 flex justify-center items-center flex-wrap">
     ...
     <div class="absolute top-1/4 -z-10 w-full">
        <div class=" flex justify-center items-center h-full">
            <img src="../../../nba_images/nba_logo.svg" alt="Svelte logo" class="opacity-20">
        </div>
    </div>
    ...
    <div class="basis-full mt-8 ">
        ...
        <h1 class="mb-4 text-4xl text-center">The Nonsense Blog App</h1>
        <div class="">
            {#if !isExpanded}
                <p class="mb-4">
            ...
            {:else}
                <p class="mb-2">
                The Nonsense Blog App is a application that allows the user to create, edit, and delete blog posts. The user can also search, filter, and get more information from each blog by going to its details page. The user can also comment and like posts. The app is built with React and uses Glitch to store JSON data for the app.
                    <button class="text-emerald-400 hover:text-emerald-400 pl-1" on:click={toggleExpansion}>Read Less</button>
                </p>
            {/if}
        </div>
...
<!--         <div class="flex justify-center lg:justify-start mt-4 gap-4">
            ...
            href="https://react-project-blog-dgm3780.netlify.app/"
            target="_blank"
            class="py-2 px-6 border border-white border-opacity-20 bg-opacity-60 rounded-full text-white bg-zinc-900 transition-all duration-300 cursor-pointer hover:bg-emerald-500">
                Go to App
            ...
            <div class="px-4 w-full max-w-[1200px] flex justify-end" bind:this={mockupsL}>
                <div class="w-[90px] sm:w-[120px] md:w-[150px] lg:w-[180px] xl:w-[210px] translate-y-[50px] sm:translate-y-[65px] md:translate-y-[80px] lg:translate-y-[95px] xl:translate-y-[110px]">
                    <video class="rounded-lg shadow-md shadow-zinc-700 border-4 border-black float-right" autoplay loop >
                        <source src="../../../nba_images/nba_video_mobile.mp4" type="video/mp4" class="">
                    </video>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap text-center justify-center gap-4">
            ...
            <button class="md:basis-5/12 p-4 border border-opacity-20 bg-zinc-900 bg-opacity-60 border-white rounded-md hover:hover:translate-y-[-0.5rem] transition-all duration-300 hover:border-emerald-500">
                <a href="../caseStudies/sta">
                    <div class="flex justify-center">
                        <img src="../../../sta_link.svg" alt="Svelte logo with words Svelte Tutorial App" class="rounded-md">
                    </div>
                    <p class="my-2 italic">2023</p>
